...
<script type="text/javascript">
	...
	function deleteGrade(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("deleteGrade",{delIds:ids},function(data){
	...
	function openGradeAddDialog(){
		...
		url="${pageContext.request.contextPath}/management/addGrade";
	}
	...
	function openGradeModifyDialog(){
		...
		$("#fm").form("load",row);
		url="${pageContext.request.contextPath}/management/updateGrade";
	}
...
<body style="margin: 5px;">
	<table id="dg" title="班级信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/management/gradeList" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px;height: 280px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				...
				<tr>
				<td><input type="text" name="id" id="id"  required="true" hidden="true"/></td>
				</tr>
			</table>
		</form>
	</div>
